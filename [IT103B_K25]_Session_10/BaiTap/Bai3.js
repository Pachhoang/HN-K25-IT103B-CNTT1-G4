...
console.log("Tổng các bàn thắng của các cầu thủ đạt đủ chỉ tiêu là : " + getFilteredTotalGoals(5, players));

console.log("Tổng các bàn thắng của các cầu thủ đạt đủ chỉ tiêu là : " + getFilteredTotalGoals(50, players));
function getFilteredTotalGoals(minGoals, teamPlayers){
    return teamPlayers
        .filter(c => c.goals >= minGoals)
